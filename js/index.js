...
var cardsItems = document.querySelectorAll(".card-price");
var cardsTitles = document.querySelectorAll(".card-price__title");
cardsItems.forEach((card, index) => {
	card.addEventListener("click", () => {
		...
		cardsTitles[index].classList.add("active");
	});
});
//#endregion
...
var tabButtons = document.querySelectorAll(".tabs-history__title");
var tabImages = document.querySelectorAll(".tabs-history__body");
...
var images = document.querySelectorAll(".tabs-history__body");
var iconsImg = document.querySelectorAll(".tabs-history__image-icon");
buttons.forEach((button, index) => {
	button.addEventListener("click", () => {
		buttons.forEach((btn, i) => {
			btn.classList.remove("--tab-active");
			images[i].classList.remove("active");
			iconsImg[i].src = icons[i].inactive;
		});
		button.classList.add("--tab-active");
		images[index].classList.add("active");
		iconsImg[index].src = icons[index].active;
	});
});
//#endregion
...
function initSliders() {
	if (document.querySelector(".testimonials__slider, [data-fls-slider]")) new Swiper(".testimonials__slider", {
		...
		pagination: {
			el: ".testimonials__dotts-pagination",
			clickable: true
		},
		on: {}
	});
	if (document.querySelector("[data-fls-slider]")) new Swiper(".our-blog__slider", {
		modules: [Autoplay, Pagination],
		observer: true,
		observeParents: true,
		slidesPerView: 2,
